...
class Exam extends CI_Controller {
	...
	public function add_exam()
	{
		...
		$this->load->view('exam/exam_add',$data);
	...
	public function add_exam_period()
	{
		...
		$this->load->view('exam/exam_period_add',$data);
		$this->template->getFooter(); 
	}
	...
	public function add_insert_marks()
	{
		...
		$this->load->view('exam/insert_marks_add',$data);
		$this->template->getFooter(); 
	...
	public function add_student_marks($session_id="",$class_section_id="",$exam_period_id="",$student_id="")
	{
		...
		$this->load->view('exam/add_student_marks',$data);
	}
	...
	public function submit_student_marks()
	{
		...
		if ($this->input->post('hd_class_section_id'))
        $class_section_id = $this->input->post('hd_class_section_id');
		...
		redirect(base_url().'index.php/exam/exam/insert_exam_marks/'.$this->input->post('hd_session_id').'/'.$class_section_id.'/'.$this->input->post('hd_exam_period_id'));
	}
}
?>