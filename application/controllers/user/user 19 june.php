			...
			switch ($user_type['login_type'])
			{
				...
				case 'C':
					...
					else
					{
						...
						$this->session->set_userdata($userdata);
						redirect('dashboard/coordinator', 'refresh');
					}
				break;
				case 'T':
					...
					{
					$userdata = array('is_logged_in' => true,'user_type' => 'T','teacher'=>$query);
					$this->session->set_userdata($userdata);
				...
				case 'P':
					...
					else
					{
                                            ...
                                            $userdata = array('is_logged_in' => true,'user_type' => 'P','parent'=>$query);
						$this->session->set_userdata($userdata);
