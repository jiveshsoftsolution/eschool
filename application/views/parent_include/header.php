  ...
  <div class="container head_s_a">
    ...
    <div class="row">
      <div class="twelve columns">
		...
		<li><a href="<?php echo base_url()?>index.php/dashboard/dashboard/parents" style="padding:0px 5px 0px 5px !important; margin-0 !important"><img src="<?php echo base_url()?>assets/assets/img/1_home.png"></a></li></li>
		<?php
