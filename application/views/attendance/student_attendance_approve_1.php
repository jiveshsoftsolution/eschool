							...
							<?php $count = 1;  for($i=0; $i < count($studentListForSendSms) ; $i++) {?>
								<tr>
									...
									<td>
										...
										?>
										<input type="radio" readonly="true" name="attendance[<?php echo $studentListForSendSms[$i]->student_teacher_class_id; ?>]" disabled checked="checked" value="P">
									...
									<td>
						               <?php               if(isset($attendance_status[0])){
										if($attendance_status[0] == "A"){
											...
											?>
										  <input type="radio" name="attendance[<?php echo $studentListForSendSms[$i]->student_teacher_class_id; ?>]"  checked="checked" value="A" disabled>
									...
									<td>
										...
										if($attendance_status[0] == "L"){										
											?>
											<input type="radio" readonly="true" name="attendance[<?php echo $studentListForSendSms[$i]->student_teacher_class_id; ?>]"  checked="checked" value="L" disabled>
