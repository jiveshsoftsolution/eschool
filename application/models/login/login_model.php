...
//         }
        ...
        function student_login($student_id = NULL,$session_id = null) 
		{
			  ...
			  {
				$this->db->select('emsparent.father_first_name,emsparent.father_middle_name,emsparent.father_last_name,emsstudent.first_name,emsstudent.middle_name,emsstudent.last_name,emsstudent.student_Id,emsstudent.email,ems_student_teacher_class.class_section_id,ems_student_teacher_class.student_teacher_class_id');
			...
			{                 
                 ...
                 foreach($query->result() as $user){
                   ...
                   if($user->father_last_name){
                      ...
                      $parentData = array('user_id' => $user->parent_id,
                             'userName' => $userName,
                           'email' => $user->mail_to
